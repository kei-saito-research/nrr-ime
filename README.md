...
**Quick links**
- Manuscript snapshot: `manuscript/current/paper4-nrr-ime-v69.tex` / `paper4-nrr-ime-v69.pdf`
- [Positioning (NRR vs related approaches)](./docs/positioning.md)
- [Search keywords](./docs/keywords.md)
...
- `manuscript/current/paper4-nrr-ime-v69.tex`
- `manuscript/current/paper4-nrr-ime-v69.pdf`
...
|-- manuscript/
|   `-- current/
|       |-- paper4-nrr-ime-v69.tex
|       |-- paper4-nrr-ime-v69.pdf
...
default so the tracked manuscript snapshot remains unchanged.
...
See `reproducibility.md` for fixed settings, bundled artifacts, and rerun commands.
...
- https://github.com/kei-saito-research/nrr-coupled
- https://github.com/kei-saito-research/nrr-projection
